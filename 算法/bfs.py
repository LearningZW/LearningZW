# 如果vlsiPartitioning.py和bfs.py不在同一个文件夹：
# import sys
# sys.path.append(r'vlsiPartitioning.py所在文件路径')
import vlsiPartitioning as vP
import networkx as nx
from collections import namedtuple,deque

def bfs(start_node, end_node, graph):  # 开始节点  目标节点 图字典
    nums_path=0 #独立搜索路径的条数
...
print(bfs(0,34,nx.karate_club_graph()))